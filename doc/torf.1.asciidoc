...
"`$FOO`" or "`${FOO}`" will be replaced by the value of *FOO*, "`$`" is escaped
with "`\`" and a literal "`\`" is represented by "`\\`".  More complex string
manipulation syntax is not supported.
