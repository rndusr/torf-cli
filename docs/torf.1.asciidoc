...
_TORRENT_.
+
If _PATH_ ends with a path separator (e.g. "/"), the name of the torrent (as
specified in _TORRENT_) is appended.
...
+
When verifying data, the torrent's name is appended.
